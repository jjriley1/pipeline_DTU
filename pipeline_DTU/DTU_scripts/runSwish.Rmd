...
sample_table_1 = sample_table_1 %>% mutate(identifier = (str_split(sample_id, "-")%>%unlist())[1])
...
sample_table_2 = sample_table_2 %>% mutate(identifier = (str_split(sample_id, "-")%>%unlist())[1])
