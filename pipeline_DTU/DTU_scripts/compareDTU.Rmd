...
expression_data_summary_var1_1 = expression_data_summary %>% dplyr::filter(var1 %in% condition1_vars) %>%
...
expression_data_summary_var1_2 = expression_data_summary %>% dplyr::filter(var1 %in% condition2_vars) %>%
